...
Here, \(\mapsto^{\{1-3\}}\) is defined by:\\
\begin{minipage}{\textwidth}
  \vspace{1em}
  \begin{minipage}{0.2\textwidth}
    \begin{prooftree}
      \AxiomC{$t\mapsto t^{\prime}$}
      \UnaryInfC{$t\mapsto^{\{1-3\}}t^{\prime}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.3\textwidth}
    \begin{prooftree}
      \AxiomC{$t\mapsto t^{\prime}$}
      \AxiomC{$t^{\prime}\mapsto t^{\prime\prime}$}
      \BinaryInfC{$t\mapsto^{\{1-3\}} t^{\prime\prime}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
    \begin{prooftree}
      \AxiomC{$t\mapsto t^{\prime}$}
      \AxiomC{$t^{\prime}\mapsto t^{\prime\prime}$}
      \AxiomC{$t^{\prime\prime}\mapsto t^{\prime\prime\prime}$}
      \TrinaryInfC{$t\mapsto^{\{1-3\}} t^{\prime\prime\prime}$}
    \end{prooftree}
  \end{minipage}
  \hfill
  \vspace{1em}
